...
describe "interaction for BooksController", type: :feature do
  ...
  describe "index" do
    it "should show me the list" do
      ...
      expect(page).to have_content(book1.blurb)
      expect(page).to have_content(book1.long_description)
      expect(page).to have_content(book1.cost)
      ...
      expect(page).to have_content(book1.release_on)
      expect(page).to have_content(book1.time_of_day)
      expect(page).to have_content(book1.selected)
  ...
  describe "new & create" do
    it "should create a new Book" do
      ...
      new_long_description = FFaker::Lorem.paragraphs(1).join() 
  ...
  describe "edit & update" do
    it "should return an editable form" do
     ...
     find("[name='book[cost]']").fill_in(with: new_cost)
      ...
      find("[name='book[how_many_printed]']").fill_in(with: new_how_many_printed)
      new_approved_at = DateTime.current + 1.day 
      find("[name='book[approved_at]']").fill_in(with: new_approved_at)
      new_release_on = Date.current + rand(100).days 
      find("[name='book[release_on]']").fill_in(with: new_release_on)
